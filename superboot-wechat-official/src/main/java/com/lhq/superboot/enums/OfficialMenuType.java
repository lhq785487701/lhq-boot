...
public enum OfficialMenuType {
    ...
    OfficialMenuType(String code, String value) {
        this.code = code;
        this.desc = value;
    }
    ...
    public static String getValue(String code) {
        OfficialMenuType[] wechatErrCodeEnums = values();
        for (OfficialMenuType wechatErrCodeEnum : wechatErrCodeEnums) {
            if (wechatErrCodeEnum.code.equals(code)) {
                return wechatErrCodeEnum.desc;
            }
        }
        return null;
    }
