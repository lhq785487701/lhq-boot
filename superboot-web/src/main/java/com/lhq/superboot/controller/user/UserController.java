...
public class UserController {
    ...
    public Object getCurrentUser() {
        return userService.getCurrentManager();
    }

    @ApiOperation("获取公钥")
    @GetMapping("/rsa/publickey")
    public Object getPublicKey(String userId) {
        return userService.getPublicKey(userId);
    }

    /**
     * @return
     * @Description: 获取xcx的用户
     */
    @GetMapping("/xcx/getCurrentUser")
    public Object getWechatCurrentUser() {
        return userService.getCurrentConsumer();
    }
    ...
    public Object registerPcUser(@RequestBody UserRegisterQo userRegisterQo) {
        ...
        // 验证手机验证码
        if (!smsCodeService.validateCode(userRegisterQo.getPhone(), userRegisterQo.getValidCode())) {
