...
public class RoleController {
    ...
    public Object grantAuthUsers(@RequestBody UserGrantQo userGrantQo) {
        ...
        // 判断是否为管理员用户
        if (!userService.checkUserRole(userList) && userList.size() == 1) {
            throw new SuperBootException("lhq-superboot-role-0008");
        } else if (!userService.checkUserRole(userList) && userList.size() > 1) {
            throw new SuperBootException("lhq-superboot-role-0007");
        }
