...
public class WhiteListServiceImpl implements WhiteListService {
    ...
    public List<WhiteListUrl> selectWhiteListUrl() {
        WhiteListUrlExample whiteListUrlExample = new WhiteListUrlExample();
        whiteListUrlExample.setOrderByClause("whitelist_id desc");
        List<WhiteListUrl> whiteList = whiteMapper.selectByExample(whiteListUrlExample);

        logger.trace("白名单列表：{}", whiteList);
        return whiteList;
    }
