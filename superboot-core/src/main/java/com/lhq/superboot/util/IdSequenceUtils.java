...
/**
 * @Description: 唯一序列ID，原生java算法
 * @author: lihaoqi
 * @date: 2019年7月9日 下午3:27:06
 * @version: v1.0.0
 */
@Component
public class IdSequenceUtils {
     ...
     * @param lastTimestamp
     * @return
     * @Description: 比较当前时间戳和下一个时间戳，如果下一个时间戳等于或小于当前时间戳，则循环获取下个时间戳 该方法主要是避免同一时间获取同一时间戳
     */
