...
public class AopConfig {
    ...
    private final String POINT_CUT = "within(com.lhq.superboot.controller..*) "
            ...
            + "&& !execution(public * com.lhq.superboot.controller.wx.official.*.*(..))"
            + "&& !execution(public * com.lhq.superboot.controller.user.RechargeController.userRechargeNotify(..))"
            + "&& !execution(public * com.lhq.superboot.controller.api.ApiController.api(..))";
