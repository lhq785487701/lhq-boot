...
/**
 * @Description: 微信支付相关的工具
 * @author: lihaoqi
 * @date: 2019年7月3日 下午10:44:40
 * @version: v1.0.0
 */
public class WechatPayUtils {

    private static final String SYMBOLS = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWechatYZ";
    ...
    public static Map<String, String> xmlToMap(String strXML) throws Exception {
        try {
            ...
            WechatPayUtils.getLogger().warn("Invalid XML, can not convert to map. Error message: {}. XML content: {}",
    ...
    public static String mapToXml(Map<String, String> data) throws Exception {
        org.w3c.dom.Document document = WechatPayXmlUtils.newDocument();
     ...
     * @param key  API密钥
     * @return 含有sign字段的XML
     * @Description: 生成带有 sign 的 XML 格式字符串
     */
     ...
     * @return 签名是否正确
     * @throws Exception
     * @Description: 判断签名是否正确，必须包含sign字段，否则返回false。使用MD5签名。
     */
     ...
     * @return 签名是否正确
     * @throws Exception
     * @Description: 判断签名是否正确，必须包含sign字段，否则返回false。
     */
